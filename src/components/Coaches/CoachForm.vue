    ...
    <form @submit.prevent="submitForm">
     ...
     <div class="form-control" :class="{invalid :!firstName.isValid}">
      ...
      <div class="form-control" :class="{invalid :!description.isValid}">
         ...
         <input type="text" id="description" v-model.trim="description.val" rows="5" @blur="clearValidity('description')"/>
      ...
      <div class="form-control" :class="{invalid :!areas.isValid}">
         ...
         <div>
       <input type="checkbox" id="zumba" v-model="areas.val" value="zumba" @blur="clearValidity('areas')" >
       <label for="zumba">Zumba</label>

         </div>
          <div>
       <input type="checkbox" id="soccer" v-model="areas.val" value="soccer" @blur="clearValidity('areas')" >
       <label for="soccer">Soccer</label>

         </div>
          <div>
       <input type="checkbox" id="fitness" v-model="areas.val" value="fitness" @blur="clearValidity('areas')" >
